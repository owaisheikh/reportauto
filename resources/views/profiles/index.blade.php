        	...
        	<div class="container">
        		<div class="gallery_f_inner row imageGallery1">
        			<div class="col-lg-4 col-md-4 col-sm-6 brand manipul design print">
        				<div class="h_gallery_item">
        					<div class="g_img_item">
        						<img class="img-fluid" src="{{ asset('tempimg/gallery/project-1.jpg')}}" alt="">
        						<a class="light" href="{{ asset('tempimg/gallery/project-1.jpg')}}"><img src="{{ asset('tempimg/gallery/icon.png')}}" alt=""></a>
        					</div>
        			...
        			<div class="col-lg-4 col-md-4 col-sm-6 brand manipul creative">
        				<div class="h_gallery_item">
        					<div class="g_img_item">
        						<img class="img-fluid" src="{{ asset('tempimg/gallery/project-2.jpg')}}" alt="">
        						<a class="light" href="{{ asset('tempimg/gallery/project-2.jpg')}}"><img src="{{ asset('tempimg/gallery/icon.png')}}" alt=""></a>
        					</div>
        					<div class="g_item_text">
        			...
        			<div class="col-lg-4 col-md-4 col-sm-6 manipul creative design print">
        				<div class="h_gallery_item">
        					<div class="g_img_item">
        						<img class="img-fluid" src="{{ asset('tempimg/gallery/project-3.jpg')}}" alt="">
        						<a class="light" href="{{ asset('tempimg/gallery/project-3.jpg')}}"><img src="{{ asset('tempimg/gallery/icon.png')}}" alt=""></a>
        					</div>
        					<div class="g_item_text">
        			...
        			<div class="col-lg-4 col-md-4 col-sm-6 brand creative print">
        				<div class="h_gallery_item">
        					<div class="g_img_item">
        						<img class="img-fluid" src="{{ asset('tempimg/gallery/project-4.jpg')}}" alt="">
        						<a class="light" href="{{ asset('tempimg/gallery/project-4.jpg')}}"><img src="{{ asset('tempimg/gallery/icon.png')}}" alt=""></a>
        					</div>
        					<div class="g_item_text">
        			...
        			<div class="col-lg-4 col-md-4 col-sm-6 brand manipul design">
        				<div class="h_gallery_item">
        					<div class="g_img_item">
        						<img class="img-fluid" src="{{ asset('tempimg/gallery/project-5.jpg')}}" alt="">
        						<a class="light" href="{{ asset('tempimg/gallery/project-5.jpg')}}"><img src="{{asset('tempimg/gallery/icon.png')}}" alt=""></a>
        					</div>
        					<div class="g_item_text">
        			...
        			<div class="col-lg-4 col-md-4 col-sm-6 brand creative">
        				<div class="h_gallery_item">
        					<div class="g_img_item">
        						<img class="img-fluid" src="{{ asset('tempimg/gallery/project-6.jpg')}}" alt="">
        						<a class="light" href="{{ asset('tempimg/gallery/project-6.jpg')}}"><img src="{{ asset('tempimg/gallery/icon.png')}}" alt=""></a>
        					</div>
        					<div class="g_item_text">
